...
class ModelConfig:
    ...
    # Comma-separated module names or "all"; typical: q_proj,k_proj,v_proj,o_proj,up_proj,down_proj,gate_proj
    lora_target_modules: str = "all"
    # Additional modules to save alongside LoRA (e.g., lm_head) if needed
...
class ActorConfig:
    ...
    overlong_filtering: bool = field(default=False, init=False)
    void_trace_filtering: bool = field(default=False, init=False)
